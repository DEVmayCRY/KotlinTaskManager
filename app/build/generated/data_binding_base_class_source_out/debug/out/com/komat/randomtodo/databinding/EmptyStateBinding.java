...
public final class EmptyStateBinding implements ViewBinding {
  ...
  public static EmptyStateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.no_task;
      TextView noTask = ViewBindings.findChildViewById(rootView, id);
      if (noTask == null) {
        break missingId;
      }

      return new EmptyStateBinding((ConstraintLayout) rootView, emptyState, ivImage, noTask);
    }
